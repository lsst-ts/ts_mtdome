...
.. list-table::
    ...
    * - setLouvers
      ...
      - [double]
      - unitless
      - An array of positions with one position for each louver given as a percentage where 0 means closedand 100 fully open.
    * - closeLouvers
      -
      -
      -
    ...
    * - config
      ...
      - | unitless
        | unitless
      - | See the `Command and Configuration Protocols`_ document.
    * - park
      -
      -
      -
